    ...
    <div className="flex-1">
      <div className="field relative">
        ...
        <input
          {...field}
          id={fieldLabel}
          className={`${classInput} focus:outline-none cursor-text text-sm leading-[22px] lg:text-base text-ellipsis overflow-hidden min-h-[48px] max-h-[48px] py-3 px-[calc(0.75rem-1px)] border-solid border-[1px] border-[#838383] rounded-lg w-full ${
            touched && error ? 'border-[#f00]' : ''
          }`}
          autoComplete="off"
          placeholder=" "
        ...
        <div
          className={`${classInputFocus} duration-150 field-label scale-75 origin-[0] text-sm leading-[22px] lg:text-base bg-white text-[#838383] whitespace-nowrap text-ellipsis overflow-hidden pointer-events-none absolute top-[calc(50%-24px)] lg:leading-6 font-normal font-gordita -translate-y-1/2 mx-3 dark:bg-[#111111]`}
          aria-hidden
        >
          {fieldLabel}
        </div>
