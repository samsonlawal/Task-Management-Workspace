...
function SecondaryButton({
  ...
  // VARIANTS
  const variant_dark_cn =
    "bg-primary-dark text-white dark:bg-[#FFFFFF] dark:text-[#111111]";
  const variant_darkAuth_cn = "bg-primary-dark text-white";
  const variant_outlined_cn =
    "border-primary-dark text-primary-dark dark:border-[#4E4E4E] dark:text-[#FFFFFF]";
  const variant_outlinedURL_cn = "border-primary-dark text-primary-dark";
  const variant_outlined_light_cn =
    "border-[#E7E7E7] text-primary-dark dark:text-white dark:border-[#4E4E4E]";
  const variant_secondary_cn =
    "border-[#F3F3F3] bg-[#F3F3F3] text-primary-dark";
  const variant_text_cn =
    "bg-transparent  text-primary-dark dark:text-[#FFFFFF] border-none";
  ...
  return (
    <button
      className={cn(
        "m-0 flex shrink-0 cursor-pointer items-center justify-center gap-[10px] rounded-full border-[1px] font-[500] hover:opacity-85",
