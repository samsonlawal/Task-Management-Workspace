    ...
    <div onClick={(e) => e.stopPropagation()}>
      ...
      >
        <SelectTrigger
          className={cn(
            className,
            `flex h-[34px] cursor-pointer flex-row items-center gap-3 rounded-[6px] border-[1.7px] border-[#565656]/50 px-3 py-1 text-[12px] font-medium text-[#111] transition-all duration-300 hover:bg-[#565656]/10 active:scale-95 dark:border-[#565656]/50 dark:text-[#565656]`,
          )}
          onClick={(e) => {
        ...
        <SelectContent
          className="bg-white dark:border-[#565656]/50 dark:bg-[#111]"
